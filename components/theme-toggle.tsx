...
export function ThemeToggle() {
  ...
  return (
    <button
      type="button"
      onClick={toggle}
      className="fixed right-4 top-4 z-50 rounded-full border-2 border-border bg-card p-2.5 text-foreground shadow-md transition-all hover:scale-110 active:scale-95"

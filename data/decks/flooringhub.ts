...
const data: DeckData = {
  title: "Flooring HUB × Uniquely You! — Partnership Conversation",
...
.pricing-cards { display: flex; flex-direction: column; gap: 0; }
.pricing-card {
  background: #fff; border-radius: 16px; margin-bottom: 10px; overflow: hidden;
  box-shadow: 0 2px 12px rgba(44,11,90,0.05); border-left: 4px solid transparent;
  transition: box-shadow 0.3s ease;
}
.pricing-card:nth-child(1) { border-left-color: var(--coral); }
.pricing-card:nth-child(2) { border-left-color: var(--teal); }
.pricing-card:nth-child(3) { border-left-color: var(--blue); }
.pricing-card:nth-child(4) { border-left-color: var(--gold); }
.pricing-card.pc-open { box-shadow: 0 4px 24px rgba(44,11,90,0.1); }
.pc-header {
...
.pricing-card.pc-open .pc-arrow { transform: rotate(180deg); }
.pc-body {
  max-height: 0; overflow: hidden; transition: max-height 0.45s ease, padding 0.3s ease;
  padding: 0 24px;
}
.pricing-card.pc-open .pc-body { max-height: 300px; padding: 0 24px 20px; }
.pc-desc { font-size: 0.85rem; color: #888; margin-bottom: 14px; }
.pc-terms { display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 12px; }
.pc-term {
  background: var(--cream); border-radius: 12px; padding: 14px 16px; text-align: center;
  border: 2px solid transparent; transition: border-color 0.2s ease;
}
.pc-term--popular { border-color: var(--gold); position: relative; }
.pc-term--popular::before {
...
.pc-term--story { border-color: var(--teal); position: relative; }
.pc-term--story::before {
  content: '+ 1 story'; position: absolute; top: -10px; left: 50%; transform: translateX(-50%);
  background: var(--teal); color: #fff; font-family: var(--sans); font-size: 0.65rem; font-weight: 700;
  text-transform: uppercase; letter-spacing: 0.08em; padding: 2px 10px; border-radius: 20px;
}
.pc-term-length { display: block; font-size: 0.78rem; color: #999; font-weight: 600; text-transform: uppercase; letter-spacing: 0.08em; margin-bottom: 4px; }
.pc-term-price { display: block; font-family: var(--display); font-size: 1.5rem; color: var(--dark); }
.pc-term-per { font-size: 0.75rem; color: #aaa; }
.pc-term-save { display: block; font-size: 0.7rem; color: var(--teal); font-weight: 700; margin-top: 4px; }
...
<section class="slide slide--dark" id="cover" data-slide-index="0" data-theme="dark">
  ...
  <div class="slide-inner">
    ...
    <div class="cover-logos" data-reveal="up" data-delay="100">
      ...
      <span class="partner-logotype">
        <svg class="partner-icon" viewBox="0 0 24 24" fill="none" stroke="rgba(18,214,160,0.8)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <rect x="2" y="6" width="20" height="12" rx="2"/><path d="M2 12h20"/><path d="M12 6v12"/>
        </svg>
        Flooring HUB
      </span>
    </div>
    ...
    <h1 class="cover-title">
      <span class="line-1" data-reveal="up" data-delay="200">Flooring</span>
      <span class="line-2" data-reveal="up" data-delay="300">HUB</span>
    ...
    <p class="cover-subtitle">
      <span class="text-reveal-mask">
        <span class="text-reveal-inner">When a family is adapting their home for a wheelchair or walker, flooring isn't cosmetic — it's the foundation of independence. Your hands-on expertise and our readership are a natural fit.</span>
      </span>
    </p>
    ...
    <div class="cover-pillars" data-reveal="up" data-delay="900">
      ...
      <div class="cover-pillar">
        ...
        <span class="cover-pillar-label cover-pillar-label--teal">Local Trust</span>
      </div>
      <div class="cover-pillar">
...
<section class="slide slide--cream" id="why" data-slide-index="1" data-theme="light">
  <div class="slide-inner">
    ...
    <h2 class="section-title" data-reveal="up" data-delay="100" style="text-align:center;margin-left:auto;margin-right:auto;">For families with disabilities, the right flooring is the difference between independence and a fall.</h2>
    <p class="section-subtitle" data-reveal="up" data-delay="200" style="text-align:center;margin-left:auto;margin-right:auto;">Trip hazards, high thresholds, slippery tile — these aren't style complaints. They're safety problems. Families adapting a home for a wheelchair or walker need someone who actually knows materials, transitions, and installation — not just someone who sells product. That's what Flooring HUB does.</p>

    <div class="s2-quote" data-reveal="scale" data-delay="300">
      "Tom's been in the flooring business since 2012 — ran his own company in Ohio, then brought that experience to Raleigh. Every project gets <span class="s2-quote-em">the same hands-on, owner-led attention</span>. Our readers are the families who need exactly that kind of partner."
    </div>
    <p class="s2-author" data-reveal="fade" data-delay="500">-- On why local flooring expertise + the disability community is a natural fit</p>
    ...
    <div class="s2-timeline" id="s2Timeline">
      <div class="s2-tl-item" data-reveal="up" data-delay="600">
        ...
        <div class="s2-tl-title">Owner-led, hands-on service</div>
        <div class="s2-tl-desc">You're not a call center. Families talk to the person who actually understands materials and installation. For someone navigating a home modification for a disability, that direct relationship matters — no middlemen, no runaround.</div>
      </div>
      ...
      <div class="s2-tl-item" data-reveal="up" data-delay="800">
        ...
        <div class="s2-tl-title">North Raleigh, same community</div>
        <div class="s2-tl-desc">Flooring HUB is based right here in the Raleigh area. We mail to 10,000+ households across Wake, Durham, Orange, Johnston, and Chatham counties. Your service area and our readership overlap directly.</div>
      </div>
      ...
      <div class="s2-tl-item" data-reveal="up" data-delay="1000">
        ...
        <div class="s2-tl-desc">We're building a network of OTs, home modification specialists, and home health agencies. When an OT tells a family "you need to replace that carpet" — Flooring HUB is the name they see in the magazine they already trust. That kind of referral is earned through consistent presence.</div>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="slide-inner">
    ...
    <div class="s3-infographic">
      ...
      <div class="s3-viz" data-reveal="scale" data-delay="450">
        <div class="s3-viz-mark">
          ...
          <div class="s3-hero-number" style="color:var(--teal);">10k+</div>
        </div>
        <div class="s3-viz-label">Households</div>
        <div class="s3-viz-desc">Direct-mail reach across 5+ Triangle counties</div>
      </div>

      <div class="s3-viz" data-reveal="scale" data-delay="600">
        <div class="s3-viz-mark">
          <svg viewBox="0 0 160 160" aria-hidden="true">
            <circle cx="80" cy="80" r="65" fill="none" stroke="#FFF0CC" stroke-width="18"/>
            <circle cx="80" cy="80" r="65" fill="none" stroke="var(--gold)" stroke-width="18" stroke-linecap="round" stroke-dasharray="408" stroke-dashoffset="102" transform="rotate(-90 80 80)"/>
          </svg>
          <div class="s3-icon-badge">
            <svg viewBox="0 0 48 48" width="48" height="48" fill="none" stroke="var(--gold)" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
              <path d="M24 4l5.5 11.2 12.3 1.8-8.9 8.7 2.1 12.3L24 32l-11 5.9 2.1-12.3-8.9-8.7 12.3-1.8z"/>
            </svg>
          </div>
        </div>
        <div class="s3-viz-label">Opt-In Audience</div>
        <div class="s3-viz-desc">Readers choose to receive UY! — engaged, not passive</div>
      </div>
    </div>
    ...
    <div class="s3-pillars">
      <div class="s3-pillar s3-pillar--coral" data-reveal="up" data-delay="700">
        ...
        <h3>Print + Digital</h3>
        <p>Full-color print magazine mailed directly to homes, plus a digital edition. Your ad shows up where families actually spend time — not in a feed they scroll past.</p>
      </div>
      ...
      <div class="s3-pillar s3-pillar--teal" data-reveal="up" data-delay="850">
        ...
        <p>A magazine sits on a kitchen counter for weeks. When someone needs flooring help, they flip back to the ad they saw — not the Facebook post that disappeared three days ago.</p>
      </div>
      ...
      <div class="s3-pillar s3-pillar--gold" data-reveal="up" data-delay="1000">
        ...
        <h3>Community, Not Just Circulation</h3>
        <p>UY! features real local people with disabilities, their families, and the businesses that serve them. Advertisers aren't buying space — they're becoming part of a community.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="slide slide--cream" id="credibility" data-slide-index="3" data-theme="light">
  <div class="slide-inner">
    <div class="section-eyebrow" data-reveal="up" data-delay="0">Why Flooring HUB</div>
    <h2 class="section-title" data-reveal="up" data-delay="100" style="max-width:none;">Your reputation already does the selling. This puts it in front of the right families.</h2>

    <div class="s4-chart" id="s4Chart">
      <div class="s4-bar-col" data-reveal="up" data-delay="200">
        <div class="s4-bar-value" style="color:var(--coral);">2012</div>
        <div class="s4-bar-track" style="height:120px;background:rgba(255,107,107,0.08);">
          <div class="s4-bar-fill" style="height:0%;background:var(--coral);transition:height 1.2s var(--ease-out-expo);" data-height="100%"></div>
        </div>
        <div class="s4-bar-label">In business since 2012<br/>Ohio to Raleigh</div>
      </div>

      <div class="s4-bar-col" data-reveal="up" data-delay="350">
        <div class="s4-bar-value" style="color:var(--teal);">Owner-Led</div>
        <div class="s4-bar-track" style="height:120px;background:rgba(18,214,160,0.08);">
          <div class="s4-bar-fill" style="height:0%;background:var(--teal);transition:height 1.2s var(--ease-out-expo) 0.15s;" data-height="85%"></div>
        </div>
        <div class="s4-bar-label">Every project gets<br/>direct oversight</div>
      </div>

      <div class="s4-bar-col" data-reveal="up" data-delay="500">
        <div class="s4-bar-value" style="color:var(--gold);">Safety-First</div>
        <div class="s4-bar-track" style="height:120px;background:rgba(255,199,45,0.08);">
          <div class="s4-bar-fill" style="height:0%;background:var(--gold);transition:height 1.2s var(--ease-out-expo) 0.3s;" data-height="90%"></div>
        </div>
        <div class="s4-bar-label">Crew safety &amp; proper<br/>protective practices</div>
      </div>

      <div class="s4-bar-col" data-reveal="up" data-delay="650">
        <div class="s4-bar-value" style="color:var(--blue);">212 Trusted</div>
        <div class="s4-bar-track" style="height:120px;background:rgba(94,168,255,0.08);">
          <div class="s4-bar-fill" style="height:0%;background:var(--blue);transition:height 1.2s var(--ease-out-expo) 0.45s;" data-height="95%"></div>
        </div>
        <div class="s4-bar-label">Vouched by members<br/>of Two Twelve Network</div>
      </div>
    </div>

    <div class="s4-context">
      <div class="s4-context-card s4-context-card--quote" data-reveal="left" data-delay="300">
        <h3>From your 212 teammates</h3>
        <p>"Tom's been fantastic. He's come in, been professional. Team does a great job." — Oliver George, Voda Cleaning &amp; Restoration</p>
      </div>
      <div class="s4-context-card s4-context-card--aside" data-reveal="right" data-delay="450">
        <h3>Why this matters for our readers</h3>
        <p>Families adapting a home for a disability don't get a second chance on flooring. They need someone who shows up, explains options honestly, and gets it right the first time. That's the reputation you've already built.</p>
      </div>
    </div>
  </div>
</section>
...
<!-- ============================================================
     SLIDE 5: PARTNERSHIP TIERS
     ============================================================ -->
<section class="slide slide--cream" id="partnership" data-slide-index="4" data-theme="light">
  <div class="slide-inner">
    <div class="section-eyebrow" data-reveal="up" data-delay="0">Partnership Model</div>
    <h2 class="section-title" data-reveal="up" data-delay="100" style="max-width:none;">Three levels: Be Seen. Be Useful. Be Remembered.</h2>
    <p class="section-subtitle" data-reveal="up" data-delay="200">Each level builds on the last. Start anywhere — upgrade when the results show.</p>

    <div class="s7-staircase">
      <div class="s7-step s7-step--1" data-reveal="up" data-delay="400">
        <div class="s7-level-label">Awareness</div>
        ...
        <h3>Be Seen</h3>
        <p>Consistent, professional ad presence in every issue — name recognition builds with the families who need you.</p>
        <ul class="s7-step-items">
          <li>Print ad every issue (monthly or bimonthly)</li>
          <li>Digital-edition placement</li>
          <li>Business directory listing on uyrdu.com</li>
        </ul>
      </div>
      ...
      <div class="s7-step s7-step--2" data-reveal="up" data-delay="600">
        ...
        <ul class="s7-step-items">
          ...
          <li>Threshold &amp; transition guidance for wheelchairs and walkers</li>
...
<section class="slide slide--cream" id="pricing" data-slide-index="5" data-theme="light">
  ...
  <div class="slide-inner" style="justify-content:center;">
    ...
    <div class="pricing-cards" data-reveal="up" data-delay="260">

      <!-- BACK COVER -->
      <div class="pricing-card" id="pc1" data-reveal="up" data-delay="280">
        <div class="pc-header" onclick="togglePrice('pc1')">
          <span class="pc-size">Back Cover</span>
          <span class="pc-range">from $595/mo</span>
          <svg class="pc-arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><polyline points="6 9 12 15 18 9"/></svg>
        </div>
        <div class="pc-body">
          ...
          <div class="pc-terms">
            ...
            <div class="pc-term pc-term--story">
              ...
              <span class="pc-term-price">$695</span>
              <span class="pc-term-per">/ month</span>
      ...
      <!-- FULL PAGE -->
      <div class="pricing-card" id="pc2" data-reveal="up" data-delay="340">
        <div class="pc-header" onclick="togglePrice('pc2')">
          <span class="pc-size">Full Page</span>
          <span class="pc-range">from $395/mo</span>
          <svg class="pc-arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><polyline points="6 9 12 15 18 9"/></svg>
        </div>
        <div class="pc-body">
          ...
          <div class="pc-terms">
            ...
            <div class="pc-term pc-term--story">
              <span class="pc-term-length">24 months</span>
              <span class="pc-term-price">$495</span>
              <span class="pc-term-per">/ month</span>
      ...
      <!-- 1/2 PAGE -->
      <div class="pricing-card" id="pc3" data-reveal="up" data-delay="400">
        <div class="pc-header" onclick="togglePrice('pc3')">
          <span class="pc-size">1/2 Page</span>
          <span class="pc-range">from $295/mo</span>
          <svg class="pc-arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><polyline points="6 9 12 15 18 9"/></svg>
        </div>
        <div class="pc-body">
          ...
          <div class="pc-terms">
            ...
            <div class="pc-term pc-term--story">
              <span class="pc-term-length">24 months</span>
              <span class="pc-term-price">$370</span>
              <span class="pc-term-per">/ month</span>
              <span class="pc-term-save">Save ~17%</span>
            </div>
            <div class="pc-term pc-term--popular">
      ...
      <!-- 1/4 PAGE -->
      <div class="pricing-card" id="pc4" data-reveal="up" data-delay="460">
        <div class="pc-header" onclick="togglePrice('pc4')">
          <span class="pc-size">1/4 Page</span>
          <span class="pc-range">from $190/mo</span>
          <svg class="pc-arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><polyline points="6 9 12 15 18 9"/></svg>
        </div>
        <div class="pc-body">
          ...
          <div class="pc-terms">
            ...
            <div class="pc-term pc-term--story">
              <span class="pc-term-length">24 months</span>
              <span class="pc-term-price">$240</span>
              <span class="pc-term-per">/ month</span>
    ...
    <div class="pricing-notes" data-reveal="up" data-delay="360">
      ...
      <div class="pricing-note">
        ...
        Credit card, ACH, e-check, or invoice. Whatever works for your business.
      </div>
      <div class="pricing-note pricing-note--highlight">
        <strong>Included at every tier</strong>
        Print placement, digital-edition exposure, directory listing, ad design support, and a feature story bonus at 24+ months.
      </div>
    </div>
  </div>
</section>
...
<section class="slide slide--dark" id="start" data-slide-index="6" data-theme="dark">
  ...
  <div class="slide-inner" style="display:flex;flex-direction:column;justify-content:center;">
    ...
    <div class="cta-hidden" id="ctaReveal">
      <div class="cta-links">
        <a class="s10-cta" href="https://portal.n2pub.com/credit_card_capture" target="_blank" rel="noopener">Ready today? Set up billing</a>
        <a class="s10-cta s10-cta--secondary" href="https://portal.n2pub.com/contract" target="_blank" rel="noopener">Review the contract</a>
      </div>
      ...
      entries.forEach(function(entry) {
        if (entry.isIntersecting && !s4Chart.dataset.animated) {
          ...
          s4Chart.querySelectorAll('.s4-bar-fill').forEach(function(bar, i) {
            setTimeout(function() { bar.style.height = bar.dataset.height; }, i * 180);
          });
        }
      });
    }, { threshold: 0.25 });
    barObserver.observe(s4Chart);
  }
`,
};
